...
public class vagol extends AsyncTask<String, String, String> {
	...
	private final static String Updater = "https://raw.githubusercontent.com/MullaDev/Demon-updater1/main/Updaterdemon";    
    ...
    protected void onPreExecute() {
        ...
        if (!isOnCreate) {
            ...
            progressDialog.getWindow().setBackgroundDrawableResource(R.drawable.background_tek);    
            progressDialog.show();
        }
    }
