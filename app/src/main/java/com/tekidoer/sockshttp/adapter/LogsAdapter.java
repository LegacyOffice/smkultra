...
import com.tekidoer.ultrasshservice.logger.LogItem;
...
public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.logViewHolder>
    implements SkStatus.LogListener, Handler.Callback, View.OnTouchListener {
    ...
    public void onBindViewHolder(final logViewHolder viewHolder, final int position) {
        ...
        try {
            ...
            // Set rounded background, bold text, and serif font
            //viewHolder.textLog.setBackgroundResource(R.drawable.green_round); // Set the rounded background
            viewHolder.textLog.setText(Html.fromHtml(text)); // Set the text from HTML
            viewHolder.textLog.setTypeface(Typeface.SERIF, Typeface.BOLD); // Set serif font and bold style
